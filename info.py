...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001650425054').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_areaz')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/rqsturmovie')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/requrs/62')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/mr_rolex12')

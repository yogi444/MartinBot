...
PICS = (environ.get('PICS', 'https://telegra.ph/file/ae453262bc2699cef630f.jpg')).split()
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '2023517850' '969953510' '1118551720').split()]
